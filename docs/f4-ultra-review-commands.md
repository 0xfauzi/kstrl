...
|---|---|---|---|
| [#35](https://github.com/0xfauzi/kstrl-loop/pull/35) | feat: per-component semantic knowledge layer | (merged pre-cycle) | Pre-cycle |
| [#36](https://github.com/0xfauzi/kstrl-loop/pull/36) | feat: adversarial factory roles | `11da226` | Pre-cycle |
| [#37](https://github.com/0xfauzi/kstrl-loop/pull/37) | feat: Phase A - critical correctness fixes | `8cda264` | A |
| [#38](https://github.com/0xfauzi/kstrl-loop/pull/38) | feat: Phase D - planted-bug fixtures + calibration | `a3ea255` | D |
| [#39](https://github.com/0xfauzi/kstrl-loop/pull/39) | docs: Phase F - real-world validation | `ba01bb0` | F |
| [#40](https://github.com/0xfauzi/kstrl-loop/pull/40) | feat: Phase B - complete kstrl.toml loader | `25c99b7` | B |
| [#41](https://github.com/0xfauzi/kstrl-loop/pull/41) | test: Phase C - integration coverage | `bd0b077` | C |
| [#42](https://github.com/0xfauzi/kstrl-loop/pull/42) | feat: Phase E (partial) - architectural refinements | `2e551bf` | E partial |
| [#43](https://github.com/0xfauzi/kstrl-loop/pull/43) | docs: Phase G - close out the roadmap | `8b423c0` | G |
