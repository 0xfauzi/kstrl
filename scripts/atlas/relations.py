...
RELATIONS: dict[tuple[str, str], str] = {
    ...
    ("KnowledgeInjector", "EngineerLoop"):
    ...
    ("PolicyEnvelope", "MechanicalVerifier"):
    ...
    ("AdequacyGate", "MechanicalVerifier"):
    ...
    ("FixturesOracle", "MechanicalVerifier"):
...
JOURNEYS: list[dict[str, object]] = [
    {
        ...
        "steps": [
            ...
            {"acts": ["Scheduler", "Worktrees"], "measures": [], "edge": ("Scheduler", "Worktrees"),
             "say": "Each ready component gets its own working copy; nothing is measured yet."},
            {"acts": ["Feedforward", "KnowledgeInjector"], "measures": [], "edge": ("Feedforward", "EngineerLoop"),
             "say": "The agent is told what the codebase looks like and what earlier components learned, before it acts."},
            {"acts": ["EngineerLoop", "AgentAdapter", "CodingAgent"], "measures": ["Breaker", "PathGuard"], "edge": ("EngineerLoop", "AgentAdapter"),
            ...
            {"acts": ["Pipeline"], "measures": ["MechanicalVerifier", "PolicyEnvelope", "AdequacyGate", "FixturesOracle"], "edge": ("Pipeline", "MechanicalVerifier"),
            ...
            {"acts": ["Scheduler"], "measures": ["AutonomyLadder", "EvolutionJournal"], "edge": ("Scheduler", "AutonomyLadder"),
    ...
    },
    {
        ...
        "steps": [
            {"acts": ["MechanicalVerifier"], "measures": ["MechanicalVerifier"], "edge": ("MechanicalVerifier", "Findings"),
             "say": "A check fails. Its output is parsed into a finding with the file, the line, the source context and a hint."},
            {"acts": ["Findings", "Pipeline"], "measures": [], "edge": ("Findings", "Pipeline"),
             "say": "The pipeline reads the finding and, with retries left, decides to try again."},
            {"acts": ["Pipeline", "RetryContext"], "measures": [], "edge": ("Pipeline", "RetryContext"),
            ...
            {"acts": ["RetryContext", "EngineerLoop"], "measures": [], "edge": ("RetryContext", "EngineerLoop"),
            ...
            {"acts": ["EngineerLoop"], "measures": ["Breaker"], "edge": ("Breaker", "EngineerLoop"),
    ...
    },
    {
        ...
        "steps": [
            {"acts": ["Operator", "Architect"], "measures": [], "edge": ("Operator", "Architect"),
            ...
            {"acts": ["OperatorContext", "Steering"], "measures": [], "edge": ("Feedforward", "EngineerLoop"),
    ...
    },
    {
        ...
        "steps": [
            {"acts": ["Scheduler", "AutonomyLadder"], "measures": [], "edge": ("Scheduler", "AutonomyLadder"),
            ...
            {"acts": ["AutonomyLadder", "Pipeline"], "measures": [], "edge": ("AutonomyLadder", "Pipeline"),
            ...
            {"acts": ["PolicyEnvelope", "AutonomyLadder"], "measures": ["PolicyEnvelope"], "edge": ("PolicyEnvelope", "AutonomyLadder"),
             "say": "One policy violation demotes one level, immediately, with a cooldown before re-promotion."},
            {"acts": ["Calibration", "HealthTrending", "AutonomyLadder"], "measures": ["Calibration", "HealthTrending"], "edge": ("Calibration", "AutonomyLadder"),
            ...
            {"acts": ["AutonomyLadder", "StateDir"], "measures": ["StateDir"], "edge": ("AutonomyLadder", "StateDir"),
