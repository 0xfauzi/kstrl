...
class TestFinding:
    ...
    def test_frozen(self) -> None:
        ...
        f = Finding(phase="review", category="x", severity="fail", location="", explanation="")
    ...
    def test_infrastructure_error_marked_explicitly(self) -> None:
        findings = [
            Finding.infrastructure_error(
                phase="security",
                explanation="agent timeout 600s",
            ),
        ]
        out = render_findings_markdown(findings)
