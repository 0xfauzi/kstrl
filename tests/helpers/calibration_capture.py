...
Five ways a run can stop, answered differently by the code under test:
...
def run_once_for(fixture_id):
    def run_once():
        ...
        # either run.
        if fixture_id == "fx-d" and MODE == "sigkill" and _fx_d_calls[0] == 2:
            os.kill(os.getpid(), signal.SIGKILL)
        if fixture_id == "fx-d" and MODE == "raise" and _fx_d_calls[0] == 2:
